...
keyboard_currency_marks = ReplyKeyboardMarkup(
    keyboard=[
        [KeyboardButton(text="🇦🇺AUD\\CHF🇨🇭"), KeyboardButton(text="🇦🇺AUD\\CAD🇨🇦")],
        [KeyboardButton(text="🇦🇺AUD\\JPY🇯🇵"), KeyboardButton(text="🇦🇺AUD\\USD🇺🇸")],
        [KeyboardButton(text="🇨🇦CAD\\JPY🇯🇵"), KeyboardButton(text="🇨🇦CAD\\CHF🇨🇭")],
        ...
        [KeyboardButton(text="🇺🇸USD\\CAD🇨🇦 OTC"), KeyboardButton(text="🇦🇺AUD\\CAD🇨🇦 OTC")],
        [KeyboardButton(text="🇪🇺EUR\\GBP🇬🇧 OTC"), KeyboardButton(text="🇺🇸USD\\CHF🇨🇭 OTC")],
        [KeyboardButton(text="Назад.")],
    ],
    resize_keyboard=True
)
